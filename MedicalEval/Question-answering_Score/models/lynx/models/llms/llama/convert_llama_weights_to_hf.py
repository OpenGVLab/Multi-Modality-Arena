...
```
python3 models/llms/llama/convert_llama_weights_to_hf.py --input_dir /mnt/bn/llmdata/llama/7B/ --model_size 7B --output_dir /mnt/bn/llmdata/zengyan/llama_yanne/7B/
```
