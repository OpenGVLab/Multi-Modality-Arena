...
class LlamaDecoderLayer(nn.Module):
    def __init__(self, config: LlamaConfig, use_adapter=False):
        super().__init__()
    ...
    def forward(
        ...
        if self.output_adapter is not None:  # add adapter
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.freeze_params = config.freeze_params  # to set no_grad() manually
        ...
        print("### Use Flash Attn", config.use_flash_attn, flush=True)
        ...
        for i in range(config.num_hidden_layers):
            ...
            self.layers.append(LlamaDecoderLayer(config, use_adapter=use_adapter))
    ...
    def forward(
        ...
        # to avoid memory increasing during training
        with torch.set_grad_enabled(not self.freeze_params):
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    def __init__(self, config):
        ...
        print("### LLM label_smoothing: ", self.label_smoothing, flush=True)
