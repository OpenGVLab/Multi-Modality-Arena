...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 use_mean_pooling=True, init_scale=0.001, use_checkpoint=False, vision_feats_return_layer=-1):
        super().__init__()

        if vision_feats_return_layer != -1:
            raise NotImplementedError("vision_feats_return_layer != -1")
...
def create_eva_vit_g(img_size=224, drop_path_rate=0.4, load_params=True, use_checkpoint=False, vision_feats_return_layer=-1):
    ...
    if load_params:
        ...
        state_dict = torch.load('/nvme/share/torch_cache/hub/checkpoints/eva_vit_g.pth', map_location='cpu')
