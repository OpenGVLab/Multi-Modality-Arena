...
from bliva.common.dist_utils import download_cached_file, is_main_process, main_process, is_dist_avail_and_initialized
...
from bliva.runners.runner_base import RunnerBase
...
class RunnerIter(RunnerBase):
    ...
    def train(self):
        ...
        if not self.evaluate_only and self.resume_ckpt_path is not None:
            print("Resume from checkpoint: {}".format(self.resume_ckpt_path))
